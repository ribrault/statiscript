...
On pourrait dire que X et Y sont proportionnel, approximativement.

"proportionnel", c'est facile à écrire : X \~ $\alpha$ . Y
X peut prendre plusieurs valeurs, Y aussi, proportionnellement à X.
# introduire la notion de variable aléatoire. Ou plus tôt ?

"approximativement"... c'est plus difficile.

Comment décrire ce côté «approximatif»?

On aimerait écrire X = alpha . Y + E

où E ajoute un écart variable autour de la valeur strictement proportionnel...
E, comme X et Y, peut prendre plusieurs valeurs. Comment décrire les valeurs qu'il peut prendre ?

# @ tim... comment expliquer E...

faire une hypothèse sur E. 
sur quelle base fonder cette hypothèse ?
...
que les X soit effectivement proportionnels à Y avec le facteur alpha et
