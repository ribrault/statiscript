...
Et si on partait plutôt d'un même jeu de données, tous ensemble.
================================================================

Ce serait peut-être plus simple. Par exemple, prenons unjeu de ??.

Quelqu'un a mesuré $X$ et $Y$ sur 132 individus.\
Combien de temps cela lui a-t-il pris, à votre avis? Combien cela lui
a-t-il coûté? Est-ce que cela a coûté à quelqu'un
...
Considérons chaque point comme un couple de mesures, $X$ et $Y$
